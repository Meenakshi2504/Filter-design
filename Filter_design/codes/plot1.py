...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.17', 'Epsilon = 0.35', 'Epsilon = 0.55', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
save_path = '../figs/plot1.png'  # Save the figure in the same directory as the script
